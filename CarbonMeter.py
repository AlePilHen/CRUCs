"""
    Description: This script calculates the energy use and carbon emissions related
                 to a job submitted to the queing system. It uses historical
                 energy price and emissions data to make this calculation. CarbonMeter
    ...
    Output:
        ...
        However, the CarbonMeter class can be imported and used to get the results.
...
class ForecastStats():
    ...
    It converts input forecast stats to a dataframe which can be used by the CarbonMeter class.
    ...
    def get_tracejob_figures(self):
        ...
        for job_id in self.id_array:
            ...
            try:
                ...
                print(f"       If you are running CarbonMeter after a snakemake pipeline jobID {job_id} will not be included in the results.", file = sys.stderr)
                continue
        ...
        if len(start_time_list) == 0:
            ...
            print("Are you running CarbonMeter after a snakemake pipeline?", file = sys.stderr)
...
class CarbonMeter():
    """
    This is the main CarbonMeter class. It takes a user input and determines
...
if __name__=="__main__":
    ...
    # Run program
    cd = CarbonMeter(user_input, input_type, config_file = "config.yaml")
    cd.run()
